...
\caption{So sánh tái dựng 3D trên test groups của các run đã hoàn tất. Hàng RGB-D đo thật là mốc tham chiếu/upper reference trong controlled setting, không phải setting triển khai RGB-only.}
\label{tab:recon}
\end{table}
