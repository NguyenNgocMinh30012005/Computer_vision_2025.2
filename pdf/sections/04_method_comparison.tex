\begin{frame}{Proposed Method}
  \begin{columns}[T]
    ...
    \begin{itemize}
      ...
      \item Targeted at sparse-view scenes without camera calibration
      \item Our study focuses on robustness, quality, and runtime
    \end{itemize}
...
\begin{frame}{Why MV-DUSt3R+ vs DUSt3R?}
  ...
  \begin{itemize}
    ...
    \item MV-DUSt3R+ is better aligned with our target setting of 2--5 sparse views.
  \end{itemize}
\end{frame}

\begin{frame}{Quantitative Evidence from the Paper}
  \centering
  \includegraphics[width=0.91\textwidth]{mvdust3r_results_table.png}

  \vspace{0.08cm}
  {\small Across multiple datasets and view counts, the highlighted rows show that MV-DUSt3R+ improves reconstruction quality while keeping runtime practical.}
...
\begin{frame}{Qualitative Motivation}
  \centering
  \includegraphics[width=0.88\textwidth]{mv_qualitative_slide.png}
