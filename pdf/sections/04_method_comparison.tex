\begin{frame}{Proposed Method}
  \begin{columns}[T]
    ...
    \vspace{0.15cm}
    \figsource{Tang et al., MV-DUSt3R+, Fig. 1: large-scene reconstruction and novel-view synthesis teaser}
...
\begin{frame}{Architecture Comparison}
  \begin{columns}[T]
    ...
    \vspace{0.08cm}
    {\scriptsize Multi-path DecBlock and CrossRefViewBlock design with cross-reference-view information flow}
  \end{columns}

  \vspace{0.12cm}
  \figsource{Left: Wang et al., DUSt3R, CVPR 2024. Right: Tang et al., MV-DUSt3R+, Fig. 5: DecBlock and CrossRefViewBlock}
\end{frame}
...
\begin{frame}{Qualitative Motivation}
  ...
  \figsource{Tang et al., MV-DUSt3R+, Fig. 6: MVS reconstruction and NVS qualitative results}
\end{frame}
