...
\begin{frame}{Direct RGB-D Backprojection Baseline}
  ...
  \begin{alertblock}{Required caution}
  ...
  \begin{block}{Evaluator warning}
    GT uses the selected input depth maps, so this is not an independent
    mesh/laser-scan benchmark. Status: submitted/pending result.
  \end{block}
\end{frame}
