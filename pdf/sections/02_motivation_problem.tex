...
\begin{frame}{Problem Statement}
  \begin{block}{Core question}
    How can we reconstruct unseen indoor scenes accurately when only 2 to 5
    sparse posed RGB-D views are available?
  \end{block}
  ...
  \begin{columns}[T]
    ...
    \begin{itemize}
      ...
      \item Sparse posed RGB-D views
      \item Known camera intrinsics/extrinsics
    ...
    \begin{itemize}
      ...
      \item Better occlusion and wrong-depth behavior
